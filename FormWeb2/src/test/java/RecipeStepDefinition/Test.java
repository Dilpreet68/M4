...
public class Test {
	...
	public void user_is_on_register_page() throws Throwable {
		...
		driver.get("D:\\Users\\dilpkaur\\SPRING WORKSPACE\\FormWeb2\\Set B\\Recipe_class_registration.html");
	...
	public void mobile_no_is_invalid() throws Throwable {
		...
		bean.setFname("Tomy");
		bean.setLname("Vats");
		bean.setEmail("tomy@example.com");
		bean.setMobile("");
		bean.setLoginButton();
	}
